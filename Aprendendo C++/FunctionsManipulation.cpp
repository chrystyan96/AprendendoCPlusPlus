...
void FunctionsManipulation::passByReference() {
...
void FunctionsManipulation::calculateByReference(float input1, float input2, char operation, float& result) {
    switch (operation) {
        case '+': {
...
void FunctionsManipulation::printEquationByReference(float input1, float input2, char operation, float result) {
...
void FunctionsManipulation::arrayAsParameter() {
    const int size = 3;
...
void FunctionsManipulation::arrayAsPointer(int* array, int size)
{
    std::cout << std::setw(5);
...
void FunctionsManipulation::arraySized(int array[3], int size)
{
    std::cout << std::setw(5);
    for (int i = 0; i < size; i++)
        std::cout << array[i] << " ";
...
void FunctionsManipulation::arrayUnSized(int array[], int size)
{
    std::cout << std::setw(5);
    for (int i = 0; i < size; i++)
        std::cout << array[i] << " ";
